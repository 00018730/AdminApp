...
const ADMIN_NAV = [
  ...
  { id:'studentslist', label:'Students',    icon:<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg> },
]
...
const TITLES = {
  students:'Students', studentslist:'Students', payments:'Payments', tests:'New Students',
...
function AdminApp({ session, onLogout }) {
  ...
  return (
    <AppShell nav={ADMIN_NAV} section={section} setSection={setSection} brand="Admin Panel" username={session?.full_name || 'admin'} onLogout={onLogout}>
      ...
      {section === 'studentslist' && <StudentsListSection role="admin" />}
